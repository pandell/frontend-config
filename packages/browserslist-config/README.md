...
- ["Browserslist is a Good Idea"](https://css-tricks.com/browserlist-good-idea/)
  (blog post by [@chriscoyier](https://github.com/chriscoyier))
...
See [browserslist.dev](https://browserslist.dev/?q=ZGVmYXVsdHMgYW5kID4gMSUsIGxhc3QgMiBDaHJvbWUgdmVyc2lvbnMsIG5vdCBkZWFkLCBub3Qgb3BfbWluaSBhbGw%3D)
for the latest browsers covered by our syntax.
